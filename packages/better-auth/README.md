...
- A running ThunderID instance with an OAuth 2.0 / OIDC application registered. See the [ThunderID documentation](https://thunderid.dev/) for details.
...
Use your existing Better Auth client, or create one. No client plugin is required, since the generic OAuth
plugin exposes sign-in through the standard social-provider API:
