...
const GoogleButton: Component = defineComponent({
  ...
  setup(props: {isLoading: boolean}, {slots, emit, attrs}: SetupContext): () => VNode {
    ...
    const googleIcon = (): VNode =>
      h(
        'svg',
        {height: '18', viewBox: '0 0 268.1522 273.8827', width: '18', xmlns: 'http://www.w3.org/2000/svg'},
        [
          h('defs', {}, [
            h('linearGradient', {id: 'google-btn-a'}, [
              h('stop', {offset: '0', 'stop-color': '#0fbc5c'}),
              h('stop', {offset: '1', 'stop-color': '#0cba65'}),
            ]),
            h('linearGradient', {id: 'google-btn-g'}, [
              h('stop', {offset: '.2312727', 'stop-color': '#0fbc5f'}),
              h('stop', {offset: '.3115468', 'stop-color': '#0fbc5f'}),
              h('stop', {offset: '.3660131', 'stop-color': '#0fbc5e'}),
              h('stop', {offset: '.4575163', 'stop-color': '#0fbc5d'}),
              h('stop', {offset: '.540305', 'stop-color': '#12bc58'}),
              h('stop', {offset: '.6993464', 'stop-color': '#28bf3c'}),
              h('stop', {offset: '.7712418', 'stop-color': '#38c02b'}),
              h('stop', {offset: '.8605665', 'stop-color': '#52c218'}),
              h('stop', {offset: '.9150327', 'stop-color': '#67c30f'}),
              h('stop', {offset: '1', 'stop-color': '#86c504'}),
            ]),
            h('linearGradient', {id: 'google-btn-h'}, [
              h('stop', {offset: '.1416122', 'stop-color': '#1abd4d'}),
              h('stop', {offset: '.2475151', 'stop-color': '#6ec30d'}),
              h('stop', {offset: '.3115468', 'stop-color': '#8ac502'}),
              h('stop', {offset: '.3660131', 'stop-color': '#a2c600'}),
              h('stop', {offset: '.4456735', 'stop-color': '#c8c903'}),
              h('stop', {offset: '.540305', 'stop-color': '#ebcb03'}),
              h('stop', {offset: '.6156363', 'stop-color': '#f7cd07'}),
              h('stop', {offset: '.6993454', 'stop-color': '#fdcd04'}),
              h('stop', {offset: '.7712418', 'stop-color': '#fdce05'}),
              h('stop', {offset: '.8605661', 'stop-color': '#ffce0a'}),
            ]),
            h('linearGradient', {id: 'google-btn-f'}, [
              h('stop', {offset: '.3159041', 'stop-color': '#ff4c3c'}),
              h('stop', {offset: '.6038179', 'stop-color': '#ff692c'}),
              h('stop', {offset: '.7268366', 'stop-color': '#ff7825'}),
              h('stop', {offset: '.884534', 'stop-color': '#ff8d1b'}),
              h('stop', {offset: '1', 'stop-color': '#ff9f13'}),
            ]),
            h('linearGradient', {id: 'google-btn-b'}, [
              h('stop', {offset: '.2312727', 'stop-color': '#ff4541'}),
              h('stop', {offset: '.3115468', 'stop-color': '#ff4540'}),
              h('stop', {offset: '.4575163', 'stop-color': '#ff4640'}),
              h('stop', {offset: '.540305', 'stop-color': '#ff473f'}),
              h('stop', {offset: '.6993464', 'stop-color': '#ff5138'}),
              h('stop', {offset: '.7712418', 'stop-color': '#ff5b33'}),
              h('stop', {offset: '.8605665', 'stop-color': '#ff6c29'}),
              h('stop', {offset: '1', 'stop-color': '#ff8c18'}),
            ]),
            h('linearGradient', {id: 'google-btn-d'}, [
              h('stop', {offset: '.4084578', 'stop-color': '#fb4e5a'}),
              h('stop', {offset: '1', 'stop-color': '#ff4540'}),
            ]),
            h('linearGradient', {id: 'google-btn-c'}, [
              h('stop', {offset: '.1315461', 'stop-color': '#0cba65'}),
              h('stop', {offset: '.2097843', 'stop-color': '#0bb86d'}),
              h('stop', {offset: '.2972969', 'stop-color': '#09b479'}),
              h('stop', {offset: '.3962575', 'stop-color': '#08ad93'}),
              h('stop', {offset: '.4771242', 'stop-color': '#0aa6a9'}),
              h('stop', {offset: '.5684245', 'stop-color': '#0d9cc6'}),
              h('stop', {offset: '.667385', 'stop-color': '#1893dd'}),
              h('stop', {offset: '.7687273', 'stop-color': '#258bf1'}),
              h('stop', {offset: '.8585063', 'stop-color': '#3086ff'}),
            ]),
            h('linearGradient', {id: 'google-btn-e'}, [
              h('stop', {offset: '.3660131', 'stop-color': '#ff4e3a'}),
              h('stop', {offset: '.4575163', 'stop-color': '#ff8a1b'}),
              h('stop', {offset: '.540305', 'stop-color': '#ffa312'}),
              h('stop', {offset: '.6156363', 'stop-color': '#ffb60c'}),
              h('stop', {offset: '.7712418', 'stop-color': '#ffcd0a'}),
              h('stop', {offset: '.8605665', 'stop-color': '#fecf0a'}),
              h('stop', {offset: '.9150327', 'stop-color': '#fecf08'}),
              h('stop', {offset: '1', 'stop-color': '#fdcd01'}),
            ]),
            h('linearGradient', {
              href: '#google-btn-a',
              id: 'google-btn-s',
            ...
            h(
              ...
              [h('feGaussianBlur', {stdDeviation: '1.700914'})],
            ),
            h(
              'filter',
              {
              ...
              [h('feGaussianBlur', {stdDeviation: '.2419367'})],
            ),
            h('clipPath', {clipPathUnits: 'userSpaceOnUse', id: 'google-btn-i'}, [
              h('path', {
          ...
          h('g', {transform: 'matrix(0.957922,0,0,0.985255,-90.17436,-78.85577)'}, [
            h('g', {'clip-path': 'url(#google-btn-i)'}, [
              h('path', {
