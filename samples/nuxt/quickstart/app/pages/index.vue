...
const { getDecodedIdToken, organizationHandle, user } = useThunderID()
...
function initials(user) {
  const name = user?.givenName || user?.given_name || user?.displayName || user?.username || ''
      ...
      <section class="hero">
        <div class="hero-inner">
          ...
          <div class="hero-stats">
            ...
            <div class="hero-stat">
              <span class="hero-stat-value">Apache 2.0</span>
      ...
      <div class="home-shell">
        <main class="home-main">
          <div class="home-greeting">
            <img v-if="user?.picture" class="home-avatar" :src="user.picture" :alt="user?.displayName || user?.username || 'User avatar'" />
            <div v-else class="home-avatar home-avatar--fallback">{{ initials(user) }}</div>
