...
<template>
  <nav class="nav">
    <NuxtLink to="/" class="nav-logo" aria-label="ThunderID home">
    ...
    <div class="nav-actions">
      <NuxtLink v-if="!isHome" to="/" class="nav-back-btn">
      ...
      <SignedOut>
        <SignInButton>
          <template #default="{ signIn, isLoading }">
            <button class="btn-ghost btn-sm" @click="signIn" :disabled="isLoading">
        ...
        <SignUpButton>
          <template #default="{ signUp, isLoading }">
            <button class="btn-primary btn-sm" @click="signUp" :disabled="isLoading">
