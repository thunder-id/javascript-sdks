...
export default function TokenDebugPage() {
  ...
  useEffect(() => {
    void fetchAccessToken().then((t) => { if (t) setRawToken(t) })
  }, [])
  ...
  const issuer = jwtPayload?.iss as string | undefined
  const audience = Array.isArray(jwtPayload?.aud) ? (jwtPayload.aud as string[]).join(', ') : jwtPayload?.aud as string | undefined
  const scopes = jwtPayload?.scope as string | undefined
